      ...
      <div ref={panelResizeHandlers.desktopInputPanelsRef} className="grid grid-cols-2 gap-6">
        <div data-input-panel>
          <TextInputPanel
            ...
            placeholder="Paste your original text here, or paste a screenshot to extract text automatically using multi-language OCR..."
        ...
        <div data-input-panel>
          <TextInputPanel
            ...
            placeholder="Paste your revised text here, or paste a screenshot to extract text automatically using multi-language OCR..."
            disabled={isProcessing}
            height={USE_CSS_RESIZE ? 9999 : panelHeight}
            iconEmoji="📝"
          />
