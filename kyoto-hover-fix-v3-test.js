// Kyoto Hover Fix V3 Test
// This script tests if our new hover fix works correctly

console.log('🧪 KYOTO HOVER FIX V3 TEST');
...
if (importantRules.length > 0) {
  console.warn('⚠️ Still using !important declarations:');
...
if (importantHandleRules.length > 0) {
  console.warn('⚠️ Still using !important declarations in hover-from-handle rules:');
