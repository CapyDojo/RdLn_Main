...
export class LanguageDetectionService {
  ...
  private static postProcessText(text: string, detectedLanguages: OCRLanguage[]): string {
    // RESTORED: 3be3ff2's proven post-processing approach
    const primaryLanguage = this.selectPrimaryLanguage(detectedLanguages);
    console.log('🧘 Processing with primary language:', primaryLanguage, 'from detected:', detectedLanguages.join(', '));
    
    // Apply 3be3ff2's gentle universal preservation
